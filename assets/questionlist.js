...
var questions = [
    ...
    {
        title: "HTML element that can be accessed in a JavaScript code: Choose on that will return an array of elements",
        choices: ["getElementById(‘idname’)", "getElementsByClass(‘classname’)", "getElementsByTagName(‘tagname’)", "querySelectorAll()"],
        answer: "querySelectorAll()",
    },
    {
        title: "There are 3 different ways in which JavaScript code can be involved in an HTML. Find the one that is not correct.",
        choices: ["Inline", "Import", "External", "Import"],
        answer: "Import",
    },
    {
        title: "The condintion in an if/else statement is enclosed in what?",
        choices: ["curly brackets", "equal sign", "parenthesis", " brackets"],
        answer: "parenthesis",
    }
]
